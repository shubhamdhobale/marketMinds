    ...
    <div className="relative flex items-center justify-center min-h-screen px-6 ">
      ...
      >
        <h2 className="text-5xl font-extrabold tracking-wide">
          Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4ECCA3] to-[#00c3ff]">Master Your Trades</span>?
        </h2>
        <p className="mt-4 text-lg tracking-wider leading-relaxed">
          Join <span className="font-bold">MarketMinds</span> today and take control of your trading journey with powerful analytics & AI insights.
        </p>
